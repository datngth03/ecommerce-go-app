...
type CartServiceClient interface {
	...
	UpdateCartItemQuantity(ctx context.Context, in *UpdateCartItemQuantityRequest, opts ...grpc.CallOption) (*CartResponse, error)
	// RPC to remove an item from the cart
	RemoveItemFromCart(ctx context.Context, in *RemoveItemFromCartRequest, opts ...grpc.CallOption) (*CartResponse, error)
...
func (c *cartServiceClient) UpdateCartItemQuantity(ctx context.Context, in *UpdateCartItemQuantityRequest, opts ...grpc.CallOption) (*CartResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CartResponse)
...
func (c *cartServiceClient) RemoveItemFromCart(ctx context.Context, in *RemoveItemFromCartRequest, opts ...grpc.CallOption) (*CartResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CartResponse)
...
type CartServiceServer interface {
	...
	// RPC to update the quantity of an item in the cart
	UpdateCartItemQuantity(context.Context, *UpdateCartItemQuantityRequest) (*CartResponse, error)
	// RPC to remove an item from the cart
	RemoveItemFromCart(context.Context, *RemoveItemFromCartRequest) (*CartResponse, error)
	// RPC to get the current state of the user's cart
...
func (UnimplementedCartServiceServer) UpdateCartItemQuantity(context.Context, *UpdateCartItemQuantityRequest) (*CartResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateCartItemQuantity not implemented")
}
func (UnimplementedCartServiceServer) RemoveItemFromCart(context.Context, *RemoveItemFromCartRequest) (*CartResponse, error) {
