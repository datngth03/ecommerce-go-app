...
const (
	RecommendationService_RecordInteraction_FullMethodName  = "/RecommendationService/RecordInteraction"
	RecommendationService_GetRecommendations_FullMethodName = "/RecommendationService/GetRecommendations"
	RecommendationService_GetPopularProducts_FullMethodName = "/RecommendationService/GetPopularProducts"
)
...
func (c *recommendationServiceClient) GetPopularProducts(ctx context.Context, in *GetPopularProductsRequest, opts ...grpc.CallOption) (*GetPopularProductsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetPopularProductsResponse)
	err := c.cc.Invoke(ctx, RecommendationService_GetPopularProducts_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRecommendationServiceServer) GetPopularProducts(context.Context, *GetPopularProductsRequest) (*GetPopularProductsResponse, error) {
...
func _RecommendationService_GetPopularProducts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetPopularProductsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RecommendationServiceServer).GetPopularProducts(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RecommendationService_GetPopularProducts_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RecommendationServiceServer).GetPopularProducts(ctx, req.(*GetPopularProductsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RecommendationService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _RecommendationService_GetPopularProducts_Handler,
		},
	},
